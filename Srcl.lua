...
local Tap01 = DinoWindow:NewPage("Auto Farm1")
local Tap010 = DinoWindow:NewPage("Auto Farm2")
local Tap011 = DinoWindow:NewPage("Auto Farm3")
local Tap2 = DinoWindow:NewPage("Stats")
local Tap3 = DinoWindow:NewPage("Teleport & Buy")
local Tap03 = DinoWindow:NewPage("Teleport & Buy1")
local Tap030 = DinoWindow:NewPage("Teleport & Buy2")
local Tap4 = DinoWindow:NewPage("Combat")
local Tap04 = DinoWindow:NewPage("Combat2")
local Tap5 = DinoWindow:NewPage("Dungeon")
local Tap6 = DinoWindow:NewPage("Misc")
local Tap06 = DinoWindow:NewPage("Misc1")
